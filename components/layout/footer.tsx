  ...
  return (
    <footer className="site-footer">
      <div className="container footer-grid">
        ...
        <div><p className="footer-heading">CONTACT</p><a href="mailto:contact@psdigilabs.in">contact@psdigilabs.in</a><a href="https://www.psdigilabs.in" target="_blank" rel="noopener noreferrer">www.psdigilabs.in</a></div>
      </div>
